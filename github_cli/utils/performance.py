...
class PerformanceMonitor:
    ...
    def end_timing(self, operation: str, **kwargs) -> PerformanceMetrics:
        ...
        if operation not in self._start_times:
            raise ValueError(
                f"No start time recorded for operation: {operation}")
    ...
    def decorator(func: Callable[P, Awaitable[T]]) -> Callable[P, Awaitable[T]]:
        ...
        async def wrapper(*args: P.args, **kwargs: P.kwargs) -> T:
            ...
            try:
                ...
                duration = time.perf_counter() - start_time
                logger.debug(
                    f"Async operation '{op_name}' completed in {duration:.4f}s")
    ...
    def decorator(func: Callable[P, T]) -> Callable[P, T]:
        ...
        def wrapper(*args: P.args, **kwargs: P.kwargs) -> T:
            ...
            try:
                ...
                duration = time.perf_counter() - start_time
                logger.debug(
                    f"Sync operation '{op_name}' completed in {duration:.4f}s")
...
def cached_async(
    ...
    def decorator(func: Callable[P, Awaitable[T]]) -> Callable[P, Awaitable[T]]:
        ...
        async def wrapper(*args: P.args, **kwargs: P.kwargs) -> T:
            ...
            logger.debug(
                f"Cache miss for {func.__qualname__}, computing result")
            result = await func(*args, **kwargs)
