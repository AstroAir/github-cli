...
class DashboardLayoutManager:
    ...
    def _create_header(self, data: Dict[str, Any]) -> Any:
    ...
    def _create_body(self, data: Dict[str, Any]) -> Layout:
        ...
        body["left"]["repositories"].update(
            self.repo_panel.create_repositories_panel(
                data.get("repositories", []))
        )
        body["left"]["pull_requests"].update(
            self.pr_panel.create_pull_requests_panel(
        ...
        body["right"]["notifications"].update(
            self.notification_panel.create_notifications_panel(
