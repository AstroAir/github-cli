...
class ResponsiveContainer(Container):
    ...
    def __init__(self, layout_manager: Optional[ResponsiveLayoutManager] = None, **kwargs):
        super().__init__(**kwargs)
        self.layout_manager = layout_manager
        self._update_responsive_classes()
    
    def _update_responsive_classes(self):
...
class TitleBar(Static):
    ...
    def __init__(self, title: str, layout_manager: Optional[ResponsiveLayoutManager] = None, **kwargs):
...
def create_responsive_layout(
    ...
    **kwargs
    ...
    with ResponsiveContainer(layout_manager=layout_manager, id="main-layout", **kwargs) as container:
        ...
        if title:
            title_bar = TitleBar(title, layout_manager=layout_manager, id="title-bar")
